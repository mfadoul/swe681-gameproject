	...
	<div id="container">
		...
		<table border="1" width="100%" align="center"
			...
			<tr valign="top">
				...
				<!-- ADD CONTENT HERE -->
					<c:if test="${sampleData ne null}">
						<h2>
							Foo: <c:out	value="${sampleData.foo}" />
						</h2>
						<h2>
							Bar: <c:out	value="${sampleData.bar}" />
						</h2>
					</c:if>
					<c:if test="${sampleData eq null}">
						<h1>Problem with sampleData: it is null.</h1>
					</c:if>
				<!-- END OF CONTENT HERE -->
				</td>
			</tr>
